      ...
      tabs: [
        {
          ...
          fields: [
            ...
            { name: 'legalName', type: 'text', label: 'Razão social', defaultValue: '__PENDENTE__', required: true },
            ...
            { name: 'foundedYear', type: 'text', label: 'Ano de fundação', defaultValue: '__PENDENTE__' },
            { name: 'tagline', type: 'text', label: 'Tagline', defaultValue: 'Advocacia com estratégia e solidez.', required: true },
            { name: 'domain', type: 'text', label: 'Domínio', defaultValue: 'cavalcantealbuquerque.com.br', required: true },
            { name: 'logoLight', type: 'upload', relationTo: 'media', label: 'Logo claro' },
            { name: 'logoDark', type: 'upload', relationTo: 'media', label: 'Logo escuro' },
            { name: 'symbol', type: 'upload', relationTo: 'media', label: 'Símbolo' },
            { name: 'ogDefault', type: 'upload', relationTo: 'media', label: 'Imagem OG padrão' },
        ...
        },
        {
          ...
          fields: [
            ...
            { name: 'whatsappDefaultMessage', type: 'textarea', label: 'Mensagem padrão do WhatsApp', defaultValue: 'Olá, gostaria de atendimento jurídico.' },
            ...
            { name: 'emergencyLine', type: 'text', label: 'Linha de emergência', defaultValue: '__PENDENTE__' },
            { name: 'emergencyLabel', type: 'text', label: 'Rótulo de emergência', defaultValue: 'Plantão criminal 24h' },
          ],
        },
        {
          label: 'Redes',
        ...
        },
        {
          label: 'Jurídico / LGPD',
          fields: [
            { name: 'privacyPolicy', type: 'richText', label: 'Política de privacidade' },
            { name: 'termsOfUse', type: 'richText', label: 'Termos de uso' },
            { name: 'cookiePolicy', type: 'richText', label: 'Política de cookies' },
            ...
            { name: 'dpoEmail', type: 'text', label: 'E-mail do encarregado', defaultValue: '__PENDENTE__' },
            {
              ...
              type: 'textarea',
              label: 'Aviso OAB',
              defaultValue: 'Informações de caráter exclusivamente informativo, sem promessa de resultado e conforme o Código de Ética e Disciplina da OAB.',
            },
          ],
        },
      ],
