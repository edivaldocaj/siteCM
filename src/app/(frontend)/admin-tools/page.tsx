...
export default function AdminToolsPage() {
  ...
  const modules = [
    ...
    { href: '/admin-tools/cards', title: 'Gerador de Cards', desc: 'Crie cards 1080×1080 e 1080×1920 com o branding CM.', color: 'var(--color-ca-steel-500)', icon: <Image style={{ width: '24px', height: '24px', color: 'var(--color-ca-steel-500)' }} /> },
