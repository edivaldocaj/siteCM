...
export default async function CampaignPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="ca-campaign-detail">
      ...
      <section className={hasVideo ? 'ca-campaign-detail-hero ca-campaign-detail-hero--with-video' : 'ca-campaign-detail-hero'}>
        {/* Background: imagem hero ou gradiente */}
        {heroImageUrl && !hasVideo && (
          <div className="ca-campaign-detail-hero__image" style={{ backgroundImage: `url(${heroImageUrl})` }} />
        )}

        <div className="ca-page-hero__mark" aria-hidden="true">
          <Image src="/brand/brand-symbol-transparent.webp" alt="" width={520} height={520} unoptimized />
        </div>

        <div className="container-narrow mx-auto ca-campaign-detail-hero__inner">
          <Link href="/campanhas" className="ca-back-link">
            <ArrowLeft size={16} />
            Voltar para Campanhas
          </Link>

          <span className="ca-campaign-detail-hero__category">
      ...
      {/* ── Conteúdo principal ── */}
      <section className="ca-campaign-detail__content">
